...
# TODO: these should be generated by the T2T wp generation algorithm
cat tests/data/*[!0-9].tc.?? | sed 's/\(.\)/\1 /g' | tr -s " " | tr " " "\n" | sort -u | sed "s/\(.\)/'\1'\n'\1_'/" > tests/outputs/t2t_vocab.txt
bin/neuralmonkey-tranin tests/wordpiece.ini
